...
export default abstract class HexGrid {
    ...
    protected constructor(gridSize: number, defaultCell?: LatticeCoords) {
    ...
    protected getAt(pos: LatticeCoords): Piece | null {
        pos = this.mod(pos);
        return this.hexGrid[pos[0]][pos[1]];
    }

    protected setAt(pos: LatticeCoords, piece: Piece | null): void {
        pos = this.mod(pos);
    ...
    protected relToAbs(relativePos: RelativePosition): LatticeCoords | null {
    ...
    protected absToRel(pos: LatticeCoords): RelativePosition | null {
